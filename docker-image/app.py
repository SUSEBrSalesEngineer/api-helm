...
def home():
    return '''<h1>Biblioteca Modelo - Versão 1</h1>
                <p>Você está acessando a <b>primeira versão da aplicação<b>.</p>
                <p>Essa é a versão de <b>teste</b>.</p>
                <p> Ela possui um problema serio!</p>'''
